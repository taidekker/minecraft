...
package net.mcreator.tutorialmod.world.biome;
...
import net.mcreator.tutorialmod.TutorialmodModElements;
...
public class TaiBiomeBiome extends TutorialmodModElements.ModElement {
	public static Biome biome;
	public TaiBiomeBiome(TutorialmodModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13108).setWaterColor(-6697729).setWaterFogColor(-3355444)
						.withSkyColor(-13108).withFoliageColor(-26266).withGrassColor(-52225).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
								Blocks.STRIPPED_CRIMSON_STEM.getDefaultState(), Blocks.STRIPPED_CRIMSON_STEM.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.ACACIA_LEAVES.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.GILDED_BLACKSTONE.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("tutorialmod:tai_biome"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("tai_biome_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Blocks.OAK_SAPLING.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("tai_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("tai_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
